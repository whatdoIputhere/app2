    ...
    fetch("https://moodle.estgv.ipv.pt/course/view.php?id=6581", {
        ...
        if (oldTesteElement != null) {
            ...
            if (oldAvalElement != newAvalElement.innerHTML) {
                ...
                // exec('start newaval.html', (error, stdout, stderr) => {
                //     if (error) {
                ...
                //     }
                // });
                // sound.play('C:\\Users\\pecarmo\\Documents\\hello\\alert.wav').then(() => {
            ...
            fs.writeFileSync('newaval.html', newAvalElement.innerHTML);
            ...
            if (oldTesteElement != newTesteElement.innerHTML) {
                ...
                console.log("Different");
                // exec('start newteste.html', (error, stdout, stderr) => {
                //     if (error) {
                //         console.error(`Error opening file: ${error}`);
                //     } else {
                //         console.log("File opened successfully");
